...
<div class="container">
  ...
  <div class="tablelist">
    ...
    if ($resultCheck == 0) {
      echo '<p class="is-size-3	has-text-centered"><strong>You have no pages created!</strong></p>';
    } else {
...
switch ($errorMessage) {
  case 'posted':
    echo "window.onload=showNoti('Page posted!', 'success');";
    break;
  case 'modified':
    echo "window.onload=showNoti('Page modified!', 'success');";
    break;
  case 'deleted':
    echo "window.onload=showNoti('Page deleted!', 'success');";
    break;
  default:
    echo "";
}
